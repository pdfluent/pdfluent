...
const handoffPath = join(__dir, '../../../src/viewer/components/ReviewHandoffPanel.tsx');
const handoffSrc = existsSync(handoffPath) ? readFileSync(handoffPath, 'utf8') : null;
...
test.describe('ReviewHandoffPanel source readiness', () => {
  ...
  test('ReviewHandoffPanel exports handoff-panel testid', () => {
    test.skip(src === null, 'ReviewHandoffPanel.tsx is not present; review handoff UI is not wired.');
